...
export class AuthenticationService {
  ...
  getOtpByAdhar(otpSentData, esVal):  Observable<any>  { 
    let headers: HttpHeaders = new HttpHeaders();
    headers = headers.append('uiToken', esVal);
   // headers = headers.append('aadhaarNo', aadharNum);
   
    //return this.httpClient.post("https://aprtacitizen.epragathi.org:8443/dl/aadhaarOtp", otpSentData, { headers: headers });
    return this.httpClient.post(this.constants.getDLUrl('AADHAR_RESULT'), otpSentData, { headers: headers });
  }

  getAadharDetails(thumbData,esVal) : Observable<any> {
    let headers: HttpHeaders = new HttpHeaders();
    headers = headers.append('uiToken', esVal);
    //headers = headers.append('onv', origin);
    //headers = headers.append('aadhaarNo', aadharNum);

    return this.httpClient.post(this.constants.getDLUrl('AADHAR_RESULT'), thumbData, {headers: headers});
  }

  getDlAadharSeedDetails(data,esVal): Observable<any> {
    let headers: HttpHeaders = new HttpHeaders();
    headers = headers.append('uiToken', esVal);
    //headers = headers.append('onv', origin);
    //headers = headers.append('aadhaarNo', aadharNum);
    return this.httpClient.post(this.constants.getDLUrl('GET_DL_AADHAR_SEED_DETAILS'), data, {headers: headers});
  }

  getLlrCancellationDetails(data,esVal): Observable<any> {
    let headers: HttpHeaders = new HttpHeaders();
    headers = headers.append('uiToken', esVal);
    return this.httpClient.post(this.constants.getDLUrl('GET_LLR_CANCELLATION_DETAILS'), data, {headers: headers});
  }
  ...
  //   return this.httpClient.get(this.constants.getDLUrl('SECURE_TOKEN'), { headers: headers });
  // }
...
  } 
  ...
  getCaptcha() : Observable<any> {
    return this.httpClient.get(this.constants.getDLUrl('GET_DL_CAPTCHA'));
  }
  ...
  */
  ...
  GetUIDPID(curr_datetime) {
    ...
    if (deviceType === 'iris') {
      ...
      this.aadhaarServiceparams = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><PidOptions ver="1.0"><Opts fCount="" fType="" iCount="1" iType="0" pCount="0" pType="" format="0" pidVer="2.0" timeout="10000" wadh="8QSrHOmcQhlyjiSpIgCi7o2ugs78w+4jhckNk1jeIJg=" env="P" /><CustOpts><Param name="ValidationKey" value=""/></CustOpts></PidOptions>';
    } else if (deviceType === 'seg') {
      this.uri = 'https://localhost:' + dynamicPort + '/rd/capture';
      this.aadhaarServiceparams = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><PidOptions ver="1.0"><Opts fCount="1" fType="0" iCount="0" iType="" pCount="0" pType="" format="0" pidVer="2.0" timeout="20000" env="P" otp="" wadh="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=" posh="LEFT_THUMB"/><CustOpts><Param name="ValidationKey" value=""/></CustOpts></PidOptions>';
    } else {
      this.uri = 'https://localhost:' + dynamicPort + '/rd/capture';
      this.aadhaarServiceparams = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><PidOptions ver="1.0"><Opts fCount="1" fType="0" iCount="0" iType="" pCount="0" pType="" format="0" pidVer="2.0" timeout="20000" env="P" otp="" wadh="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=" posh="LEFT_THUMB"/><CustOpts><Param name="ValidationKey" value=""/></CustOpts></PidOptions>';
    }
